...
// Enclose entire JavaScript under document.ready to execute after DOM
// is completely ready.
$(document).ready(function() {
 ...
 // $plannerDiv.empty(); // Don"t really need this line of code ??? What was it
                         // supposed to do??
  ...
  // function to color save button on change of textarea
  $(document).on("change","textarea", function(event) {
    event.preventDefault();  
    if (test) { console.log("onChange"); }
    if (test) { console.log("id", $(this).attr("hour")); }

    // neeed to check for save button

    let i = $(this).attr("hour");
